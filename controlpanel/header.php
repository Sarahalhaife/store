						...
						<div class="col-xs-10 text-right menu-1">
							<ul>
								...
								<li class="has-dropdown <?php if (isset($act["shop"])) echo $act["shop"];  ?>">
									...
									<ul class="dropdown">
										<li class='<?php if (isset($act["prodect"])) echo $act["prodect"];  ?>'><a href="product-detail.php">Product Detail</a></li>
										<li class='<?php if (isset($act["cart"])) echo $act["cart"];  ?>'><a href="cart.php">Shopping Cart</a></li>
										<li class='<?php if (isset($act["check"])) echo $act["check"];  ?>'><a href="checkout.php">Checkout</a></li>
									
										<li class='<?php if (isset($act["whish"])) echo $act["whish"];  ?>'><a href="add-to-wishlist.php">Wishlist</a></li>
									</ul>
								</li>
								
								<li class='<?php if (isset($act["about"])) echo $act["about"];  ?>'><a href="about.php">About</a></li>
								
								<li class='<?php if (isset($act["cart"])) echo $act["cart"];  ?>'><a href="cart.php"><i class="icon-shopping-cart"></i> Cart [0]</a></li>
							</ul>
						</div>
					</div>
				</div>
